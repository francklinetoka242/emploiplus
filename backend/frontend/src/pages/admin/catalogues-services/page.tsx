...
export default function CataloguesServicesPage() {
  ...
  const loadCategories = async () => {
    if (typeof api.getAdminServiceCategories !== 'function') {
      console.error('api.getAdminServiceCategories is not available', api);
      toast.error('Fonctionnalité catégories indisponible');
      setCategories([]);
      return;
    }
    try {
  ...
  const loadServices = async () => {
    if (typeof api.getAdminServices !== 'function') {
      console.error('api.getAdminServices is not available', api);
      toast.error('Fonctionnalité services indisponible');
      setServices([]);
      return;
    }
    try {
