  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role === "super_admin") {
        ...
        if (res.ok) {
          // ensure any previous admin session is removed so the welcome screen
          // and subsequent login are clean -- otherwise an old token/name
          // might persist and confuse the user (see bug report).
