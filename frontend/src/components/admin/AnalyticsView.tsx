...
import { Calendar, TrendingUp, TrendingDown, Users, Briefcase, AlertCircle } from "lucide-react";
...
export const AnalyticsView = ({ adminLevel = 1 }: { adminLevel?: number }) => {
  // Permission guard - this view is for Level 1 (Super Admin) only
  if (adminLevel !== 1) {
    return (
      <div className="text-center py-12 text-red-600">
        <AlertCircle className="h-12 w-12 mx-auto mb-4 opacity-50" />
        <p className="text-lg font-semibold">Accès refusé</p>
        <p className="text-sm opacity-75">Cette section est réservée aux administrateurs super admin.</p>
      </div>
    );
  }
