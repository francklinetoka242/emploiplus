...
export default function FormationsManagementPage() {
  return (
    <div className="space-y-6">
      ...
      {/* FORMATIONS LIST - PLACEHOLDER */}
      <Card className="p-8 text-center">
        <BookOpen className="h-16 w-16 text-slate-300 mx-auto mb-4" />
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Aucune formation</h3>
        <p className="text-slate-600 mb-6">Créez votre première formation</p>
        <Button className="bg-purple-600 hover:bg-purple-700 gap-2">
          <Plus className="h-4 w-4" />
          Créer une formation
        </Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="p-6">
          <p className="text-slate-600 text-sm">Actives</p>
          <p className="text-3xl font-bold mt-2">0</p>
        </Card>
        <Card className="p-6">
          <p className="text-slate-600 text-sm">Étudiants inscrits</p>
          <p className="text-3xl font-bold mt-2">0</p>
        </Card>
        <Card className="p-6">
