...
import PortfolioMinialisteEditor from "./pages/services/PortfolioMinialisteEditor";
...
import LoginHistoryPage from "./pages/admin/login-history/page";
import SystemHealthPage from "./pages/admin/system-health/page";
...
import DocumentsAdminPage from "./pages/admin/documents/page";
...
import CataloguesServicesPage from "./pages/admin/catalogues-services/page";
      ...
      <TooltipProvider>
        ...
        <HashRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          ...
          {/* Tools et Services */}
            ...
            <Route path="/services/portfolio-minimaliste-editor" element={<PortfolioMinialisteEditor />} />
          </Route>
          ...
          <Route path="/admin" element={<AdminLayout />}>
            ...
            {/* Login History — super_admin uniquement */}
            ...
            {/* System Health — super_admin uniquement */}
            ...
            <Route path="users/:userId" element={
              <ProtectedRoute requiredRoles={["super_admin", "admin_billing"]}>
                <AdminUserProfile />
              </ProtectedRoute>
            } />
            
            {/* Subscriptions — super_admin et admin_billing */}
            ...
            {/* Documents — super_admin uniquement */}
            ...
            {/* Catalogues & Services — super_admin uniquement */}
            <Route path="catalogues-services" element={
              <ProtectedRoute requiredRoles={["super_admin"]}>
                <CataloguesServicesPage />
              </ProtectedRoute>
            } />
            
            {/* Export — super_admin uniquement */}
